...
public class ShortMessageVerificationCode {
    ...
    public static String SMS(String number) throws HttpException, IOException {
        ...
        NameValuePair[] data = {//提交短信
                new NameValuePair("account", "C76820086"), //查看用户名是登录用户中心->验证码短信->产品总览->APIID
                new NameValuePair("password", "1207c73358bcb29574ab67194a367aee"),  //查看密码请登录用户中心->验证码短信->产品总览->APIKEY
