...
// bugs in the ExternalInterface library.
    SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
        ...
        // Flash's method if calling ExternalInterface methods (sms adapted from MooTools).
        try {
...
// Use the swfupload_loaded_handler event setting to execute custom sms when SWFUpload has loaded.
...
// This function is called by Flash each time the ExternalInterface functions are created.
    SWFUpload.prototype.cleanUp = function (movieElement) {
        ...
        // Fix Flashes own cleanup sms so if the SWFMovie was removed from the page
